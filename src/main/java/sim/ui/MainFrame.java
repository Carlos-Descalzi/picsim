...
public class MainFrame 
	...
	private Action openAction = ActionFactory.create(this,"openFile","Open",null,null);
	private Action resetAction = ActionFactory.create(this,"reset","Reset","F11","/reset.png");
	private Action stepOverAction = ActionFactory.create(this,"stepOver","Step Over","F7","/step-over.png");
	private Action stepIntoAction = ActionFactory.create(this,"stepInto","Step Into","F6","/step-into.png");
	private Action stepReturnAction = ActionFactory.create(this,"stepOut","Step return","F8","/step-return.png");
	private Action runToLineAction = ActionFactory.create(this,"runToLine","Run to line","F9","/run-to-line.png");	
	private Action runAction = ActionFactory.create(this,"run","Run","F5","/run.png");	
	private Action runStepped = ActionFactory.create(this,"runStepped","Run Stepped",null,"/run-stepped.png");
	private Action stopAction = ActionFactory.create(this,"stop","Stop",null,"/stop.png");	
	private Action exitAction = ActionFactory.create(this,"exit","Exit",null,null);
	private Action preferencesAction = ActionFactory.create(this,"showPreferencesDialog","Preferences",null,null);
